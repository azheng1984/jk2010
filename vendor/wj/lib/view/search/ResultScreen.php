...
class ResultScreen {
  ...
  private static function renderList() {
    ...
    foreach ($GLOBALS['URI']['RESULTS']['matches'] as $id => $content) {
      ...
      echo '<li><div class="image"><a target="_blank" href="http://www.360buy.com/" rel="nofollow"><img alt="'.$name.'" src="http://img.dev.huobiwanjia.com/'.$product['id'].'.jpg" /></a></div><h3><a href="http://www.360buy.com/'.$product['id'].'?source=huobiwanjia.com" target="_blank" rel="nofollow">',
