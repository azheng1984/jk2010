...
class ResultScreen {
  ...
  private static function renderList() {
    ...
    foreach ($GLOBALS['URI']['RESULTS']['matches'] as $id => $content) {
      ...
      echo '<li><div class="image"><a rel="nofollow" target="_blank" href="http://www.360buy.com/"><img alt="'.$name.'" src="http://img.huobiwanjia.com/'.$product['id'].'.jpg" /></a></div><h3><a rel="nofollow" target="_blank" href="http://www.360buy.com/'.$product['id'].'?source=huobiwanjia.com">',
