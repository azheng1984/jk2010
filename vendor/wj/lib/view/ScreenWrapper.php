...
class ScreenWrapper {
  ...
  private function renderBody($content) {
    ...
    echo '</div>';
    echo '<div class="left">&copy; 货比万家 <a href="http://support.wj.com/">使用条款</a> <a href="http://support.wj.com/">隐私权政策</a> 沪ICP证00000000</div>';
    echo '</div>';
    echo '</body>';
  }
  ...
  private function renderSearch() {
    ...
    echo '<div id="search"><form action="/"><input id="search_input" name="q" value="'.$query.'" /> <input id="search_button" type="submit" value="搜 索"/></form></div>';
  }
}