<?php
class MerchantProcessingPaymentScreen extends MerchantScreen {
  ...
  private function renderBreadcrumb() {
    ...
    if (isset($_GET['merchant_id'])) {
      echo ' / <a href="processing">正在付款</a> / <strong>商家</strong>';
    } elseif (isset($_GET['order_id'])) {
      echo ' / <a href="processing">正在付款</a> / <a href="?merchant_id=1">商家</a> / <strong>订单</strong>';
    } else {
      echo ' / <strong>正在付款</strong>';
    }
  }
