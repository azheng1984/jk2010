<?php
class PublisherUnfinishedOrderScreen extends MerchantScreen {
  ...
  protected function renderHtmlBodyContent() {
    ...
    MerchantNavigationScreen::render('payment');
  ...
  private function renderBreadcrumb() {
    ...
    if (isset($_GET['merchant_id'])) {
      echo ' / <a href="unfinished_order">未完成订单佣金</a> / <strong>商家</strong>';
    } elseif (isset($_GET['order_id'])) {
      echo ' / <a href="unfinished_order">未完成订单佣金</a> / <a href="?merchant_id=1">商家</a> / <strong>订单</strong>';
    } else {
      echo ' / <strong>未完成订单佣金</strong>';
    }
  }
