...
//      echo 'Response:';
        echo '<script>
            ...
            function show() {
                ...
                if ($len > 1024 * 10) {
                    ...
                    echo 'notice= "<div style=\"border-radius:5px;padding:5px;background:#ff9;color:333\">Notice: Content is partial. Length is larger than output limitation(10MB).</div>";';
                }
                $len = strlen($buffer);
                $buffer2 = null;
                $max = 1024 * 4;
    ...
    if (buffer2 != null) {
        contentx = "<div class=\"more\" onclick=\"showmore()\">Show all content</div>" + contentx
        +"<div onclick=\"showmore()\" class=\"more\">Show all content</div>";
    }
...
　　    word-wrap:break-word;/*支持IE，chrome，FF*/
    ...
    .ts {
border-radius:2px 2px 0 0;font-weight:bold;background:#eee;border:1px;border:1px solid #ccc;border-bottom:0px;margin-top:-5px;float:left;color:#333;text-decoration:none;
    }
    .more {
        width:200px;
        text-align:center;
...
#trace .frame {
    ...
    //        $trace = StackTraceFormatter::format($trace, false);
            ...
            foreach ($trace as $item) {
                ...
                echo '<tr style="border:0px solid #fff;';
                echo '"><td class="box" onclick="this.setAttribute(\'class\', \'frame\');document.getElementById(\'tf-',$index,'\').style.backgroundColor=\'#ff9\'" style="padding:6px;width:1px;font-family:arial;font-size:12px;vertical-align:middle;text-align:center;"><span style="">#', $index, '</span> <td>';
                echo '<td id="tf-',$index,'" style="border-bottom:1px dotted #ddd;padding:4px;';
                ...
                if (isset($item['file'])) {
                    ...
                    echo '<div style="margin-top:4px;color:#007700;font-size:13px;">', $file , ' <span style="color:#666;background:#eee;padding:2px 3px 0 3px;line-height:18px;box-shadow: 1px 1px 1px rgba(0,0,0,.15);border-radius:3px;font-size:12px;">',$item['line'], '</span></div>';
                } else {
