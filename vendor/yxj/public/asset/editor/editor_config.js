...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"/asset/upload_img/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["undo","redo","insertunorderedlist","insertorderedlist","unlink","link","insertimage","blockquote","bold","italic","underline","strikethrough","superscript","subscript","justifyleft","justifycenter","justifyright","removeformat","inserttable"]]
