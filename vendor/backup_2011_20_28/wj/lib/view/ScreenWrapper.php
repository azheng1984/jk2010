...
class ScreenWrapper {
  ...
  private function renderBody($content) {
    ...
    echo '</div>';
    echo '<div class="left">&copy; 货比万家 <a rel="nofollow" href="http://support.wj.com/">使用条款</a> <a rel="nofollow" href="http://support.wj.com/">隐私权政策</a> 沪 ICP 备你妹</div>';
    echo '</div>';
    echo '</body>';
  }
  ...
  private function renderLogo() {
    echo '<div id="header">';
    echo '<div id="logo"><a href="/">货比万家<span class="img"></span></a></div>';
    $this->renderSearch();
    echo '<div id="toolbar"><a class="sign_up" href="/" rel="nofollow">注册</a> <a class="sign_in" href="/" rel="nofollow">登录</a></div>';
    echo '</div>';
  }
